...
null===a.params.maxheight)&&(a.params.maxheight=a.maxHeight);for(d in a.params)d!=a.callbackparameter&&null!==a.params[d]&&(c+="&"+escape(d)+"="+a.params[d]);return h+="format="+a.format+"&url="+escape(b)+c,"json"!=a.dataType&&(h+="&"+a.callbackparameter+"=?"),h}function n(a,l,h){b("#jqoembeddata").data(l,a.code);j.beforeEmbed.call(h,a);j.onEmbed.call(h,a);j.afterEmbed.call(h,a)}function e(a,l,h){var c,d,f;if(void 0!=b("#jqoembeddata").data(l)&&"iframe"!=h.embedtag.tag)d={code:b("#jqoembeddata").data(l)},
n(d,l,a);else if(h.yql){d=h.yql.from||"htmlstring";var g=h.yql.url?h.yql.url(l):l;f="SELECT * FROM "+d+' WHERE url="'+g+'" and '+(/html/.test(d)?"xpath":"itemPath")+"='"+(h.yql.xpath||"/")+"'";"html"==d&&(f+=" and compat='html5'");f=b.extend({url:m()+"query.yahooapis.com/v1/public/yql",dataType:"jsonp",data:{q:f,format:"json",env:"store://datatables.org/alltableswithkeys",callback:"?"},success:function(c){var d,f,e,k,j;if(h.yql.xpath&&"//meta|//title|//link"==h.yql.xpath){d={};null==c.query.results&&
...
c.query.results.link[e].rel&&(d["og:image"]="/"==c.query.results.link[e].href.charAt(0)?g.match(/^(([a-z]+:)?(\/\/)?[^\/]+\/).*$/)[1]+c.query.results.link[e].href:c.query.results.link[e].href)}c=h.yql.datareturn(d)}else c=h.yql.datareturn?h.yql.datareturn(c.query.results):c.query.results.result;!1!==c&&(j=b.extend({},c),j.code=c,n(j,l,a))},error:function(){j.onError.call(a,l,h)}},j.ajaxOptions||{});b.ajax(f)}else if(h.templateRegex)if(""!==h.embedtag.tag){d=h.embedtag.flashvars||"";f=h.embedtag.tag||
"embed";c=h.embedtag.width||"auto";var e=h.embedtag.height||"auto",p=l.replace(h.templateRegex,h.apiendpoint);if(h.nocache||(p+="&jqoemcache="+o(5)),h.apikey&&(p=p.replace("_APIKEY_",j.apikeys[h.name])),j.maxHeight&&j.maxWidth)if(j.useResponsiveResize){var r=0,s=c,t=e;c>j.maxWidth&&(r=j.maxWidth/c,s=j.maxWidth,t=e*r,e*=r,c*=r);e>j.maxHeight&&(r=j.maxHeight/e,t=j.maxHeight,s=c*r,c*=r);e=t;c=s}else e=j.maxHeight,c=j.maxWidth;c=b("<"+f+"/>").attr("src",p).attr("width",c).attr("height",e).attr("allowfullscreen",
h.embedtag.allowfullscreen||"true").attr("allowscriptaccess",h.embedtag.allowfullscreen||"always").css("max-height",j.maxHeight||"auto").css("max-width",j.maxWidth||"auto");"embed"==f&&c.attr("type",h.embedtag.type||"application/x-shockwave-flash").attr("flashvars",l.replace(h.templateRegex,d));"iframe"==f&&c.attr("scrolling",h.embedtag.scrolling||"no").attr("frameborder",h.embedtag.frameborder||"0");d={code:c};n(d,l,a)}else h.apiendpoint?(h.apikey&&(h.apiendpoint=h.apiendpoint.replace("_APIKEY_",
j.apikeys[h.name])),f=b.extend({url:l.replace(h.templateRegex,h.apiendpoint),dataType:"jsonp",success:function(c){var d=b.extend({},c);d.code=h.templateData(c);n(d,l,a)},error:function(){j.onError.call(a,l,h)}},j.ajaxOptions||{}),b.ajax(f)):(d={code:l.replace(h.templateRegex,h.template)},n(d,l,a));else d=q(h,l),f=b.extend({url:d,dataType:h.dataType||"jsonp",success:function(c){c=b.extend({},c);switch(c.type){case "file":case "photo":c.code=b.fn.oembed.getPhotoCode(l,c);break;case "video":case "rich":c.code=
...
return 0===b("#jqoembeddata").length&&b('<span id="jqoembeddata"></span>').appendTo("body"),this.each(function(){var d=b(this),f=a&&(!a.indexOf("http://")||!a.indexOf("https://"))?a:d.attr("href"),g,l,m,n,o;if(h?j.onEmbed=h:j.onEmbed||(j.onEmbed=function(a){b.fn.oembed.insertCode(this,j.embedMethod,a)}),null!==f&&void 0!==f){l=0;for(m=c.length;l<m;l++)if(n=RegExp("://"+c[l]+"/","i"),null!==f.match(n))return o=b.extend({url:"http://api.longurl.org/v2/expand",dataType:"jsonp",data:{url:f,format:"json"},
success:function(a){f=a["long-url"];g=b.fn.oembed.getOEmbedProvider(a["long-url"]);null!==g?(g.params=p(j[g.name])||{},g.maxWidth=j.maxWidth,g.maxHeight=j.maxHeight,e(d,f,g)):j.onProviderNotFound.call(d,f)}},j.ajaxOptions||{}),b.ajax(o),d;g=b.fn.oembed.getOEmbedProvider(f);null!==g?(g.params=p(j[g.name])||{},g.maxWidth=j.maxWidth,g.maxHeight=j.maxHeight,e(d,f,g)):j.onProviderNotFound.call(d,f)}return d})};var j;b.fn.oembed.defaults={maxWidth:null,maxHeight:null,useResponsiveResize:!1,includeHandle:!0,
...
function(a,b){return b.html};b.fn.oembed.getGenericCode=function(a,b){var e='<a href="'+a+'">'+(null!==b.title?b.title:a)+"</a>";return b.html&&(e+="<div>"+b.html+"</div>"),e};b.fn.oembed.getOEmbedProvider=function(a){for(var e,h,c,d=0;d<b.fn.oembed.providers.length;d++){e=0;for(h=b.fn.oembed.providers[d].urlschemes.length;e<h;e++)if(c=RegExp(b.fn.oembed.providers[d].urlschemes[e],"i"),null!==a.match(c))return b.fn.oembed.providers[d]}return null};b.fn.oembed.OEmbedProvider=function(a,e,h,c,d){this.name=
a;this.type=e;this.urlschemes=h;this.apiendpoint=c;this.maxWidth=500;this.maxHeight=400;d=d||{};d.useYQL&&(d.yql="xml"==d.useYQL?{xpath:"//oembed/html",from:"xml",apiendpoint:this.apiendpoint,url:function(a){return this.apiendpoint+"?format=xml&url="+a},datareturn:function(a){return a.html.replace(/.*\[CDATA\[(.*)\]\]>$/,"$1")||""}}:{from:"json",apiendpoint:this.apiendpoint,url:function(a){return this.apiendpoint+"?format=json&url="+a},datareturn:function(a){var c,d,e;if("video"!=a.json.type&&(a.json.url||
a.json.thumbnail_url))return'<img src="'+(a.json.url||a.json.thumbnail_url)+'"  />';if(a.json.html.indexOf("iframe")){var a=b.parseHTML(a.json.html),f=a[0].width,l=a[0].height;return j.maxHeight&&j.maxWidth&&(j.useResponsiveResize?(d=f,e=l,f>j.maxWidth&&(c=j.maxWidth/f,d=j.maxWidth,e=l*c,l*=c,f*=c),l>j.maxHeight&&(c=j.maxHeight/l,e=j.maxHeight,d=f*c),l=e,f=d):(l=j.maxHeight,f=j.maxWidth)),a[0].width=f,a[0].height=l,a[0].outerHTML}return a.json.html||""}},this.apiendpoint=null);for(var f in d)this[f]=
d[f];this.format=this.format||"json";this.callbackparameter=this.callbackparameter||"callback";this.embedtag=this.embedtag||{tag:""}};b.fn.oembed.providers=[new b.fn.oembed.OEmbedProvider("youtube","video",["youtube\\.com/watch.+v=[\\w-]+&?","youtu\\.be/[\\w-]+"],m()+"www.youtube.com/oembed",{useYQL:"json"}),new b.fn.oembed.OEmbedProvider("youtubeiframe","video",["youtube.com/embed"],"$1?wmode=transparent",{templateRegex:/(.*)/,embedtag:{tag:"iframe",width:"425",height:"349"}}),new b.fn.oembed.OEmbedProvider("wistia",
"video",["wistia.com/m/.+","wistia.com/embed/.+","wi.st/m/.+","wi.st/embed/.+"],"http://fast.wistia.com/oembed",{useYQL:"json"}),new b.fn.oembed.OEmbedProvider("xtranormal","video",["xtranormal\\.com/watch/.+"],"http://www.xtranormal.com/xtraplayr/$1/$2",{templateRegex:/.*com\/watch\/([\w\-]+)\/([\w\-]+).*/,embedtag:{tag:"iframe",width:"320",height:"269"}}),new b.fn.oembed.OEmbedProvider("scivee","video",["scivee.tv/node/.+"],"http://www.scivee.tv/flash/embedCast.swf?",{templateRegex:/.*tv\/node\/(.+)/,
embedtag:{width:"480",height:"400",flashvars:"id=$1&type=3"}}),new b.fn.oembed.OEmbedProvider("veoh","video",["veoh.com/watch/.+"],"http://www.veoh.com/swf/webplayer/WebPlayer.swf?version=AFrontend.5.7.0.1337&permalinkId=$1&player=videodetailsembedded&videoAutoPlay=0&id=anonymous",{templateRegex:/.*watch\/([^\?]+).*/,embedtag:{width:"410",height:"341"}}),new b.fn.oembed.OEmbedProvider("gametrailers","video",["gametrailers\\.com/video/.+"],"http://media.mtvnservices.com/mgid:moses:video:gametrailers.com:$2",
{templateRegex:/.*com\/video\/([\w\-]+)\/([\w\-]+).*/,embedtag:{width:"512",height:"288"}}),new b.fn.oembed.OEmbedProvider("funnyordie","video",["funnyordie\\.com/videos/.+"],"http://player.ordienetworks.com/flash/fodplayer.swf?",{templateRegex:/.*videos\/([^\/]+)\/([^\/]+)?/,embedtag:{width:512,height:328,flashvars:"key=$1"}}),new b.fn.oembed.OEmbedProvider("colledgehumour","video",["collegehumor\\.com/video/.+"],"http://www.collegehumor.com/moogaloop/moogaloop.swf?clip_id=$1&use_node_id=true&fullscreen=1",
...
"rich",["mixcloud.com/.+"],m()+"www.mixcloud.com/oembed/",{useYQL:"json"}),new b.fn.oembed.OEmbedProvider("rdio.com","rich",["rd.io/.+","rdio.com"],m()+"www.rdio.com/api/oembed/"),new b.fn.oembed.OEmbedProvider("Soundcloud","rich",["soundcloud.com/.+","snd.sc/.+"],m()+"soundcloud.com/oembed",{format:"js"}),new b.fn.oembed.OEmbedProvider("bandcamp","rich",["bandcamp\\.com/album/.+"],null,{yql:{xpath:"//meta[contains(@content, \\'EmbeddedPlayer\\')]",from:"html",datareturn:function(a){return a.meta?
...
a.json)}}}),new b.fn.oembed.OEmbedProvider("mobypicture","photo",["mobypicture.com/user/.+/view/.+","moby.to/.+"],"http://api.mobypicture.com/oEmbed"),new b.fn.oembed.OEmbedProvider("flickr","photo",["flickr\\.com/photos/.+"],"https://secure.flickr.com/services/oembed",{callbackparameter:"jsoncallback"}),new b.fn.oembed.OEmbedProvider("photobucket","photo",["photobucket\\.com/(albums|groups)/.+"],m()+"photobucket.com/oembed/"),new b.fn.oembed.OEmbedProvider("instagram","photo",["instagr\\.?am(\\.com)?/.+"],
m()+"api.instagram.com/oembed"),new b.fn.oembed.OEmbedProvider("SmugMug","photo",["smugmug.com/[-.\\w@]+/.+"],"http://api.smugmug.com/services/oembed/"),new b.fn.oembed.OEmbedProvider("dribbble","photo",["dribbble.com/shots/.+"],"http://api.dribbble.com/shots/$1?callback=?",{templateRegex:/.*shots\/([\d]+).*/,templateData:function(a){return a.image_teaser_url?'<img src="'+a.image_teaser_url+'"/>':!1}}),new b.fn.oembed.OEmbedProvider("chart.ly","photo",["chart\\.ly/[a-z0-9]{6,8}"],"http://chart.ly/uploads/large_$1.png",
...
String.prototype.md5=function(){var b=function(b,m){var j=(b&65535)+(m&65535);return(b>>16)+(m>>16)+(j>>16)<<16|j&65535},m=function(e,m,j,a,l,h){e=b(b(m,e),b(a,h));return b(e<<l|e>>>32-l,j)},o=function(b,p,j,a,l,h,c){return m(p&j|~p&a,b,p,l,h,c)},q=function(b,p,j,a,l,h,c){return m(p&a|j&~a,b,p,l,h,c)},n=function(b,p,j,a,l,h,c){return m(j^(p|~a),b,p,l,h,c)};return function(b){for(var m="",j=4*b.length,a=0;a<j;a++)m+="0123456789abcdef".charAt(b[a>>2]>>8*(a%4)+4&15)+"0123456789abcdef".charAt(b[a>>2]>>
8*(a%4)&15);return m}(function(e){for(var p,j,a,l,h=e.length,c=1732584193,d=-271733879,f=-1732584194,g=271733878,k=0;k<h;k+=16)p=c,j=d,a=f,l=g,c=o(c,d,f,g,e[k+0],7,-680876936),g=o(g,c,d,f,e[k+1],12,-389564586),f=o(f,g,c,d,e[k+2],17,606105819),d=o(d,f,g,c,e[k+3],22,-1044525330),c=o(c,d,f,g,e[k+4],7,-176418897),g=o(g,c,d,f,e[k+5],12,1200080426),f=o(f,g,c,d,e[k+6],17,-1473231341),d=o(d,f,g,c,e[k+7],22,-45705983),c=o(c,d,f,g,e[k+8],7,1770035416),g=o(g,c,d,f,e[k+9],12,-1958414417),f=o(f,g,c,d,e[k+10],
17,-42063),d=o(d,f,g,c,e[k+11],22,-1990404162),c=o(c,d,f,g,e[k+12],7,1804603682),g=o(g,c,d,f,e[k+13],12,-40341101),f=o(f,g,c,d,e[k+14],17,-1502002290),d=o(d,f,g,c,e[k+15],22,1236535329),c=q(c,d,f,g,e[k+1],5,-165796510),g=q(g,c,d,f,e[k+6],9,-1069501632),f=q(f,g,c,d,e[k+11],14,643717713),d=q(d,f,g,c,e[k+0],20,-373897302),c=q(c,d,f,g,e[k+5],5,-701558691),g=q(g,c,d,f,e[k+10],9,38016083),f=q(f,g,c,d,e[k+15],14,-660478335),d=q(d,f,g,c,e[k+4],20,-405537848),c=q(c,d,f,g,e[k+9],5,568446438),g=q(g,c,d,f,e[k+
14],9,-1019803690),f=q(f,g,c,d,e[k+3],14,-187363961),d=q(d,f,g,c,e[k+8],20,1163531501),c=q(c,d,f,g,e[k+13],5,-1444681467),g=q(g,c,d,f,e[k+2],9,-51403784),f=q(f,g,c,d,e[k+7],14,1735328473),d=q(d,f,g,c,e[k+12],20,-1926607734),c=m(d^f^g,c,d,e[k+5],4,-378558),g=m(c^d^f,g,c,e[k+8],11,-2022574463),f=m(g^c^d,f,g,e[k+11],16,1839030562),d=m(f^g^c,d,f,e[k+14],23,-35309556),c=m(d^f^g,c,d,e[k+1],4,-1530992060),g=m(c^d^f,g,c,e[k+4],11,1272893353),f=m(g^c^d,f,g,e[k+7],16,-155497632),d=m(f^g^c,d,f,e[k+10],23,-1094730640),
c=m(d^f^g,c,d,e[k+13],4,681279174),g=m(c^d^f,g,c,e[k+0],11,-358537222),f=m(g^c^d,f,g,e[k+3],16,-722521979),d=m(f^g^c,d,f,e[k+6],23,76029189),c=m(d^f^g,c,d,e[k+9],4,-640364487),g=m(c^d^f,g,c,e[k+12],11,-421815835),f=m(g^c^d,f,g,e[k+15],16,530742520),d=m(f^g^c,d,f,e[k+2],23,-995338651),c=n(c,d,f,g,e[k+0],6,-198630844),g=n(g,c,d,f,e[k+7],10,1126891415),f=n(f,g,c,d,e[k+14],15,-1416354905),d=n(d,f,g,c,e[k+5],21,-57434055),c=n(c,d,f,g,e[k+12],6,1700485571),g=n(g,c,d,f,e[k+3],10,-1894986606),f=n(f,g,c,d,
e[k+10],15,-1051523),d=n(d,f,g,c,e[k+1],21,-2054922799),c=n(c,d,f,g,e[k+8],6,1873313359),g=n(g,c,d,f,e[k+15],10,-30611744),f=n(f,g,c,d,e[k+6],15,-1560198380),d=n(d,f,g,c,e[k+13],21,1309151649),c=n(c,d,f,g,e[k+4],6,-145523070),g=n(g,c,d,f,e[k+11],10,-1120210379),f=n(f,g,c,d,e[k+2],15,718787259),d=n(d,f,g,c,e[k+9],21,-343485551),c=b(c,p),d=b(d,j),f=b(f,a),g=b(g,l);return[c,d,f,g]}(function(b){for(var m=(b.length+8>>6)+1,j=[],a=16*m,l=b.length,h=0;h<a;h++)j.push(0);for(a=0;a<l;a++)j[a>>2]|=(b.charCodeAt(a)&
